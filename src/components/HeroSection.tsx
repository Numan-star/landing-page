...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[45vh] md:min-h-[80vh] w-full text-white overflow-hidden">
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 h-full w-full">
              ...
              <div className="flex items-center justify-center px-2 md:px-6 py-2 md:pt-7 mb:pb-3">
      ...
      <div className="mb-0 sm:mb-4 mt-4 sm:mt-0 flex items-center justify-center px-2 sm:px-20 md:px-16 xl:px-20 2xl:px-36 gap-2 text-sm text-gray-400">
        {slides.map((_, i) => (
          <span
            key={i}
            className={`h-[3px] w-8 rounded-sm transition-all duration-300 ${
